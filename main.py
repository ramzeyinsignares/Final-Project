...
# for scoring
#score starts at 0 
# increases by getting ball past paddle
...
while True:
    ...
    # Ball Movement
    #Rate at which ball is moving around screen
    #Controls ball and way it bounces
    #Goal: Want ball to bounce off of paddles

    ball.setx(ball.xcor() + ball.dx)
    ball.sety(ball.ycor() + ball.dy)

    # Ball's Border checking
    #bounces ball opposite way
    if ball.ycor() > 290:
        ball.sety(290)
        ball.dy *= -1   
...
#if ball goes past paddle add score to player which scored
#Getting ball past paddle is key objective
